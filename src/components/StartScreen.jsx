    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          <div style={{ fontSize: fs(26), letterSpacing: 6, color: "#4ab3f4" }}>⛩ SPERANZA</div>
          <div style={{ fontSize: fs(8), letterSpacing: 3, color: "#2a4a6a", marginTop: 5 }}>
            UNDERGROUND COLONY
          </div>
          <div style={{ fontSize: fs(9), color: "#4a5a6a", marginTop: 12, lineHeight: 1.6 }}>
            The surface belongs to the Arc. Everything you have left is below it.
          </div>
        </div>

        <div style={{ marginBottom: 16 }}>
          <label htmlFor="colony-name" style={{ display: "block", color: "#2a4a6a", fontSize: fs(8), letterSpacing: 2, marginBottom: 6 }}>
            COLONY NAME
          </label>
          <input
            id="colony-name"
            ...
            style={{
              ...
              color: "#4ab3f4", padding: "9px 11px", fontSize: fs(13), letterSpacing: 2,
        ...
        <div style={{ marginBottom: 18 }}>
          <div style={{ color: "#2a4a6a", fontSize: fs(8), letterSpacing: 2, marginBottom: 6 }}>DIFFICULTY</div>
            ...
            {DIFFICULTY_ORDER.map(key => {
              ...
              return (
                <button
                  ...
                  aria-pressed={on}
                  style={{
                    flex: 1, padding: "9px 4px", cursor: "pointer", fontSize: fs(9),
          ...
          <div style={{
            minHeight: 30, color: "#5a6a7a", fontSize: fs(9), lineHeight: 1.5,
            background: "#0a0c14", border: "1px solid #12202c", borderRadius: 4, padding: "7px 9px",
          }}>
            {DIFFICULTIES[difficulty].desc}
          </div>
          <div style={{ color: "#2a3a4a", fontSize: fs(8), marginTop: 6, letterSpacing: 1 }}>
        ...
        <button onClick={begin} style={{
          ...
          fontSize: fs(12), letterSpacing: 3, fontFamily: "'Courier New', monospace",
        }}>BEGIN</button>
      </div>
    </div>
  );
