...
import { RAID_SIZES, RAID_SIZE_ORDER, RAID_LAUNCH_CHANCE, fs,} from "../gameData.js";
...
export default function RaidBanner({ activeRaid, raidWindow, radioTowerOnline, unlockedTechs }) {
  ...
  return (
    <div style={{
      width: "100%", maxWidth: fs(920), marginBottom: 10,
      ...
      {activeRaid ? (
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
          <div>
            <div style={{ color: "#ff4444", fontSize: fs(13), fontWeight: "bold", letterSpacing: 2 }}>
              {RAID_SIZES[activeRaid.sizeKey].icon} {RAID_SIZES[activeRaid.sizeKey].label} RAID IN PROGRESS
            </div>
            <div style={{ color: "#884444", fontSize: fs(9), marginTop: 3, letterSpacing: 1 }}>
              Arc forces are breaching the perimeter — production is at risk
            </div>
          </div>
          <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ color: "#ff6666", fontSize: fs(18), fontWeight: "bold", fontFamily: "monospace" }}>{activeRaid.ticksLeft}</div>
              <div style={{ color: "#5a2a2a", fontSize: fs(8), letterSpacing: 1 }}>TICKS LEFT</div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ color: activeRaid.strikeCountdown <= 5 ? "#ff4444" : "#f5a623", fontSize: fs(18), fontWeight: "bold", fontFamily: "monospace" }}>
                {activeRaid.strikeCountdown}
              </div>
              <div style={{ color: "#5a2a2a", fontSize: fs(8), letterSpacing: 1 }}>NEXT STRIKE</div>
            </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
          <div>
            <div style={{ color: "#ff6622", fontSize: fs(13), fontWeight: "bold", letterSpacing: 2 }}>
              {radioTowerOnline
            ...
            <div style={{ color: "#7a3a1a", fontSize: fs(9), marginTop: 3, letterSpacing: 1 }}>
          ...
          {radioTowerOnline && unlockedTechs.includes("barricades") && (
            <div style={{ color: "#4a8a4a", fontSize: fs(9), letterSpacing: 1 }}>
