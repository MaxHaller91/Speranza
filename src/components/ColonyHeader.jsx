    ...
    <div style={{ width: "100%", maxWidth: 920, marginBottom: 10, position: "relative", zIndex: 1 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "1px solid #1e3a5f", paddingBottom: 8, marginBottom: 10, flexWrap: "wrap", gap: 8, background: "rgba(3,6,9,0.55)", backdropFilter: "blur(2px)" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 3, marginTop: 5, alignItems: "center" }}>
            ...
            <button title="Toggle Colony Log" onClick={(e) => { e.stopPropagation(); onToggleJournal(); }} style={{
              ...
              padding: "2px 6px", cursor: "pointer", fontSize: 10, fontFamily: "monospace", marginLeft: 4,
            }}>📜</button>
            <button title="Toggle Colony Effects" onClick={(e) => { e.stopPropagation(); onToggleEffects(); }} style={{
              ...
              padding: "2px 6px", cursor: "pointer", fontSize: 10, fontFamily: "monospace", marginLeft: 2,
            }}>🧪</button>
            <button
              title="Report Bug"
              onClick={(e) => {
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          <button onClick={onRecruit} style={{ background: "#0a2a1a", border: "1px solid #2a7a4a", borderRadius: 6, color: "#7ed321", padding: "8px 12px", cursor: "pointer", fontSize: 10, letterSpacing: 1 }}>+ RECRUIT</button>
        </div>
      </div>
