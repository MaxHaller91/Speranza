...
export default function Speranza() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const threatThisTick = (THREAT_PER_TICK + builtRooms * 0.35) * condThreatMult;
              ...
              <div style={{ background: "#080b14", border: "1px solid #1a2a3a", borderRadius: 8, padding: 10 }}>
                ...
                {col.backstory && (
                  <div style={{ marginBottom: 8 }}>
                    ...
                    <div style={{ color: "#445566", fontSize: 7, lineHeight: 1.6, fontStyle: "italic" }}>{col.backstory}</div>
                  </div>
                )}
                <div>
